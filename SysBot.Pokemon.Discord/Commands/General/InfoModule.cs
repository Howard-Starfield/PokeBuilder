...
{
    private const string detail = "I am an open-source Pokémon trading Discord bot maintained by Howard-Starfield.";

    private const string repo = "https://github.com/Howard-Starfield/PokeBuilder";
