...
public static class EmbedHelper
{
    public static async Task SendNotificationEmbedAsync(IUser user, string message)
    {
        var embed = new EmbedBuilder()
            ...
            .WithThumbnailUrl("https://raw.githubusercontent.com/Howard-Starfield/sprites/main/exclamation.gif")
            .WithColor(Color.Red)
            .Build();

        await user.SendDirectMessageAsync(embed: embed).ConfigureAwait(false);
    }
    ...
    public static async Task SendTradeCanceledEmbedAsync(IUser user, string reason)
    {
        var embed = new EmbedBuilder()
            ...
            .WithTimestamp(DateTimeOffset.Now)
            .WithThumbnailUrl("https://raw.githubusercontent.com/Howard-Starfield/sprites/main/dmerror.gif")
            .WithColor(Color.Red)
            .Build();
    ...
    public static async Task SendTradeCodeEmbedAsync(IUser user, int code)
    {
        var embed = new EmbedBuilder()
            ...
            .WithTimestamp(DateTimeOffset.Now)
            .WithThumbnailUrl("https://raw.githubusercontent.com/Howard-Starfield/sprites/main/tradecode.gif")
        ...
        where T : PKM, new()
    {
        ...
        if (isMysteryEgg)
        {
            thumbnailUrl = "https://raw.githubusercontent.com/Howard-Starfield/sprites/main/mysteryegg3.png";
        }
        else
        {
    ...
    public static async Task SendTradeInitializingEmbedAsync(IUser user, string speciesName, int code, bool isMysteryEgg, string? message = null)
    {
        ...
        var embed = new EmbedBuilder()
            ...
            .WithTimestamp(DateTimeOffset.Now)
            .WithThumbnailUrl("https://raw.githubusercontent.com/Howard-Starfield/sprites/main/initializing.gif")
        ...
        await user.SendDirectMessageAsync(embed: builtEmbed).ConfigureAwait(false);
    }
    ...
    public static async Task SendTradeSearchingEmbedAsync(IUser user, string trainerName, string inGameName, string? message = null)
    {
        var embed = new EmbedBuilder()
            ...
            .WithTimestamp(DateTimeOffset.Now)
            .WithThumbnailUrl("https://raw.githubusercontent.com/Howard-Starfield/sprites/main/searching.gif")
