...
public static class WebApiExtensions
{
    ...
    private static void CleanupStalePortFiles()
    {
        try
        {
            ...
            var exeDir = Path.GetDirectoryName(exePath) ?? ConfigLoader.WorkingDirectory;
    ...
    public static void NotifyBotsStarted(IPokeBotRunner runner)
    {
        _server?.InitializeSupabaseIfNeeded(runner);
    }

    public static void NotifyBotsStopped()
    {
        _server?.StopSupabasePoller();
    }
