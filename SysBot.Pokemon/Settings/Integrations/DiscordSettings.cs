...
public class DiscordSettings
{
    ...
    [Category(Startup), Description("URL opened when clicking the Discord bot status embed title. Leave blank to disable the link.")]
    public string BotStatusUrl { get; set; } = "https://resume.howardlab.dev/";
