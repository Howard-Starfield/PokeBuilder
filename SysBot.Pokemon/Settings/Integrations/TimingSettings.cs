...
public class TimingSettings
{
    ...
    [Category(Misc), Description("[LGPE] Extra time in milliseconds to wait for checking if the game is running.")]
    public int ExtraTimeCheckGame { get; set; }

    [Category(Misc), Description("When enabled, adds extra delay to check if the game is running after reopening.")]
    public bool CheckGameDelay { get; set; }

    [Category(Misc), Description("Set to true if the Switch requires profile selection when launching the game.")]
    public bool ProfileSelectionRequired { get; set; }
}
