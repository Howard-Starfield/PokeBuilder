...
public interface IPokeTradeNotifier<T> where T : PKM, new()
{
    ...
    /// <summary> Updates batch trade progress for multi-Pokemon trades. </summary>
    void UpdateBatchProgress(int currentBatchNumber, T currentPokemon, int uniqueTradeID) { }

    /// <summary> Updates the unique trade ID. </summary>
    void UpdateUniqueTradeID(int uniqueTradeID) { }
}
