...
public static class Program
{
    ...
    private static void ExitNoConfig()
    {
        ...
        ProgramConfigPersistence.SaveAtomic(cfg, ConfigPath, out _);
    ...
    private static void Main(string[] args)
    {
        ...
        foreach (var message in result.Messages)
            LogUtil.LogInfo("SysBot", message);

        PokeTradeBotSWSH.SeedChecker = new Z3SeedSearchHandler<PK8>();
        BotContainer.RunBots(result.Config);
    }
}
...
public static class BotContainer
{
    ...
    private static IPokeBotRunner GetRunner(ProgramConfig prog) => prog.Mode switch
    {
        ...
        ProgramMode.LZA => new PokeBotRunnerImpl<PA9>(new PokeTradeHub<PA9>(prog.Hub), new BotFactory9LZA(), prog),
